...
public class BSTree<T extends Comparable<? super T>> {   
   ...
   public int countBetween(T a,T b,BSTNode<T> n){
      if (n==null) return 0;
      if (a.compareTo(n.getValue())<=0 && b.compareTo(n.getValue())>=0) return (1+(countBetween(a,b, n.getLeft())+countBetween(a,b, n.getRight())));
   ...
   public boolean valid(BSTNode<T> n){
      ...
      if (n.getLeft()!=null && n.getRight()!=null){
         ...
         if (n.getLeft()==null){
            return n.getRight().getValue().compareTo(n.getValue())>0;
         }else{
            if (n.getRight()==null){
               return n.getLeft().getValue().compareTo(n.getValue())<0;
            }
         }
      }
